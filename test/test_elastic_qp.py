...
def test_with_qpax():
    ...
    x_big, s_big, z_big, y, converged_big, pdip_iter_big = jax.jit(qpax.solve_qp)(Q2,q2,A2, b2, G2,h2, solver_tol=1e-10)
    ...
    _x, _t, _s1, _s2, _z1, _z2, _converged, _pdip_iter = jax.jit(qpax.elastic_qp.solve_qp_elastic)(Q, q, G, h, penalty, solver_tol=1e-10)
    assert _converged == 1
